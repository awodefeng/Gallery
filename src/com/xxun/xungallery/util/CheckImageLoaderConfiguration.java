...
import com.xxun.xungallery.universalimageloader.cache.disc.naming.Md5FileNameGenerator;
...
import com.xxun.xungallery.universalimageloader.core.ImageLoaderConfiguration;
...
//			ImageLoaderConfiguration config = ImageLoaderConfiguration.createDefault(context);默认配置也很好用哦！！！
            ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(context)
                    ...
                    .diskCache(new LruDiskCache(cacheDir, new Md5FileNameGenerator(), cacheDiskMaxSize))
