...
import com.xxun.xungallery.adapter.AlbumAdapter;
...
public class AlbumFragment extends BaseFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        mActivity = (MainPhotoActivity) activity;
    ...
    private void getVideoThumbnail() {
        ...
        if (getActivity() != null) {
            ...
            Log.d(TAG, "[getVideoThumbnail] >> cursor == null || cursor.getCount() < 0");
        }
        } else {
            Log.e(TAG, "getVideoThumbnail getActivity() == null");
        } 
    ...
    private void getVideoData() {
        ...
        if (getActivity() != null) {
            ...
            if (cursor != null && cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                Log.e(TAG, "moveToNext >> sName = " + cursor.getString(2));
                // add by guohongcheng_20170824
                if (!cursor.getString(2).equals("Pictures") 
                    && !cursor.getString(2).equals("photo_img")
                    && !cursor.getString(2).equals("resources")
                    && !cursor.getString(2).equals("galleryclock")
                    && !cursor.getString(2).equals("chat_audio")) {
                    ...
                    Log.e(TAG, "getVideoData >> sName = " + cursor.getString(2) + " skip!");
                }
            }
        }
        } else {
            Log.e(TAG, "getVideoData getActivity() == null");
        }       
    ...
    private void getImageData() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                ...
                Log.d(TAG, "[getImageData] >> name: " + cursor.getString(2));
                ...
                if (!cursor.getString(2).equals("Pictures") 
                    ...
                    Log.d(TAG, "sPath: " + sPath + " ; " + mThumbnailList.get(s_ID));
                    ...
                    Log.e(TAG, "sName == Pictures, skip.");
                }
            }
        } else {
            Log.e(TAG, "[getImageData] >> cursor = null!!");
        }
